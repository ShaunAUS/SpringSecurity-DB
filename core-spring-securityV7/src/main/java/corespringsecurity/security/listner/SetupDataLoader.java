package corespringsecurity.security.listner;

import corespringsecurity.domain.entity.*;
import corespringsecurity.repository.*;
...
public class SetupDataLoader implements ApplicationListener<ContextRefreshedEvent> {
    ...
    //서버 기동할떄 기본적 사용자정보,자원정보,권한정보 세팅
